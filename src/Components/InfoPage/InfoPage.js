...
function InfoPage(props) {
  ...
  const getConstituencyDetails = async (lang = "en") => {
    ...
    body.append("state_id", props.state);
  ...
  <div>
     ...
     <div className="gridContainer">
        ...
        <div className="gridItem item3"><h5> ELECTORS </h5> {data.total_voters} </div>
        <div className="gridItem item4"> 
          <h5 className="putInLeft">VOTER TURN OUT : <em className="largeText">{data.voterturnout}</em></h5>
          <div id="inBottom">
            <div className="percentageGap">
              <div><h5 >MEN ( {data.male}55% )&nbsp;&nbsp;&nbsp;&nbsp;</h5></div> 
              <div><h5 >WOMEN ( {data.female}45% )</h5></div>
            </div>
          </div>
        </div>
        <div className=" item5"> 
        ...
        <div className="winnerPic">
            ...
            <div className="detail">
               ...
               <h6 className="winnerBottomRight"><img src={data.runnerup_logo} alt="runnerup logo" height="25" ></img></h6>
